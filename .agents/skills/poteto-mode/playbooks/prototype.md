...
5. Verify visually on the matching surface with available tooling: screenshot each variant, drive the interaction. The eye is the test here, not an assertion.
