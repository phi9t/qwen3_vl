...
1. Capture the live signal on the matching surface with available runtime tooling: a CPU profile for a spinning process, a heap snapshot for a leak, or a trace for a visual glitch. A real artifact, not a guess.
